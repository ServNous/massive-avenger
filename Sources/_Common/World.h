...
#define	ADDOBJ( pObj, bAddItToGlobalId, nLayer )	AddObj( (pObj), (bAddItToGlobalId) )
	...
	#ifdef __LAYER_1015
		#include "..\7_WorldServer\layeredlinkmap.h"
	#else	// __LAYER_1015
		#include "..\7_WorldServer\LinkMap.h"
	#endif	// __LAYER_1015
#endif
...
#ifdef __JEFF_11_4
	BOOL	IsArena( void )	
		{	return( m_dwWorldID == WI_WORLD_ARENA || m_dwWorldID == WI_WORLD_ARENA_1 );	}

	BOOL   IsGwar( void )   
		{   return( m_dwWorldID == WI_WORLD_GUILDWAR );   }
#endif	// __JEFF_11_4
